...
public:
    ...
    void setExpiresAt(utility::string_t value);
    bool expires_atIsSet() const;
    ...
    /// 
    /// </summary>
    utility::string_t getBirthdayAt() const;
    void setBirthdayAt(utility::string_t value);
    bool birthday_atIsSet() const;
    void unsetBirthday_at();
    /// <summary>
    /// 
    /// </summary>
...
utility::string_t m_Resume;
    bool m_ResumeIsSet;
utility::string_t m_Birthday_at;
    bool m_Birthday_atIsSet;
