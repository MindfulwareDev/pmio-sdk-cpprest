...
void Task::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(U("attributes")))
    {
        ...
        {
            std::shared_ptr<Task_attributes> newItem(new Task_attributes());
...
utility::string_t Task::getId() const
{
	return m_Id;
}
void Task::setId(utility::string_t value)
{
	m_Id = value;
    m_IdIsSet = true;
}
...
std::shared_ptr<Task_attributes> Task::getAttributes() const
{
	return m_Attributes;
}
void Task::setAttributes(std::shared_ptr<Task_attributes> value)
{
	m_Attributes = value;
    m_AttributesIsSet = true;
}
bool Task::attributesIsSet() const
{
    return m_AttributesIsSet;
}
void Task::unsetAttributes() 
{
    m_AttributesIsSet = false;
}
