...
void User::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(U("attributes")))
    {
        ...
        {
            std::shared_ptr<User_attributes> newItem(new User_attributes());
...
utility::string_t User::getType() const
{
	return m_Type;
}
void User::setType(utility::string_t value)
{
	m_Type = value;
    
}
std::shared_ptr<User_attributes> User::getAttributes() const
{
	return m_Attributes;
}
void User::setAttributes(std::shared_ptr<User_attributes> value)
{
	m_Attributes = value;
    m_AttributesIsSet = true;
}
bool User::attributesIsSet() const
{
    return m_AttributesIsSet;
}
void User::unsetAttributes() 
{
    m_AttributesIsSet = false;
}
