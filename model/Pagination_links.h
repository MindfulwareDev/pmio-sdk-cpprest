...
#ifndef Pagination_links_H_
#define Pagination_links_H_
...
public:
    ...
    void setNext(utility::string_t value);
    ...
    void setPrevious(utility::string_t value);
