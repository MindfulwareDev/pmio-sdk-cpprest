...
void Process::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(U("attributes")))
    {
        ...
        {
            std::shared_ptr<Process_attributes> newItem(new Process_attributes());
...
std::shared_ptr<Process_attributes> Process::getAttributes() const
{
	return m_Attributes;
}
void Process::setAttributes(std::shared_ptr<Process_attributes> value)
{
	m_Attributes = value;
    m_AttributesIsSet = true;
}
bool Process::attributesIsSet() const
{
    return m_AttributesIsSet;
}
void Process::unsetAttributes() 
{
    m_AttributesIsSet = false;
}
