...
utility::string_t Gateway_attributes::getCreatedAt() const
{
	return m_Created_at;
}
void Gateway_attributes::setCreatedAt(utility::string_t value)
{
	m_Created_at = value;
...
utility::string_t Gateway_attributes::getUpdatedAt() const
{
	return m_Updated_at;
}
void Gateway_attributes::setUpdatedAt(utility::string_t value)
{
	m_Updated_at = value;
