...
{
    {
        ...
        for( auto& item : val[U("data")].as_array() )
        {
            ...
            if(item.is_null()) 
            {
                m_Data.push_back( std::shared_ptr<Group>(nullptr) );
            }
            else
            {
...
std::vector<std::shared_ptr<Group>>& GroupCollection::getData()
{
	return m_Data;
}
bool GroupCollection::dataIsSet() const
{
    return m_DataIsSet;
}
void GroupCollection::unsetData() 
{
    m_DataIsSet = false;
}
std::shared_ptr<Meta> GroupCollection::getMeta() const
{
	return m_Meta;
}
void GroupCollection::setMeta(std::shared_ptr<Meta> value)
{
	m_Meta = value;
    m_MetaIsSet = true;
}
bool GroupCollection::metaIsSet() const
{
    return m_MetaIsSet;
}
void GroupCollection::unsetMeta() 
{
    m_MetaIsSet = false;
}
