...
void Group::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(U("attributes")))
    {
        ...
        {
            std::shared_ptr<Group_attributes> newItem(new Group_attributes());
...
utility::string_t Group::getType() const
{
	return m_Type;
}
void Group::setType(utility::string_t value)
{
	m_Type = value;
    
}
std::shared_ptr<Group_attributes> Group::getAttributes() const
{
	return m_Attributes;
}
void Group::setAttributes(std::shared_ptr<Group_attributes> value)
{
	m_Attributes = value;
    m_AttributesIsSet = true;
}
bool Group::attributesIsSet() const
{
    return m_AttributesIsSet;
}
void Group::unsetAttributes() 
{
    m_AttributesIsSet = false;
}
