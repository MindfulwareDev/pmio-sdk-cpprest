...
utility::string_t Group_attributes::getCreatedAt() const
{
	return m_Created_at;
}
void Group_attributes::setCreatedAt(utility::string_t value)
{
	m_Created_at = value;
...
utility::string_t Group_attributes::getUpdatedAt() const
{
	return m_Updated_at;
}
void Group_attributes::setUpdatedAt(utility::string_t value)
{
	m_Updated_at = value;
