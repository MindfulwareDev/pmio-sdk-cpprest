...
pplx::task<std::shared_ptr<EventConnector_1>> ProcessmakerApi::addEventConnector(utility::string_t processId, utility::string_t eventId, std::shared_ptr<EventConnectorCreateItem> eventConnectorCreateItem)
{
    
    // verify the required parameter 'eventConnectorCreateItem' is set
    if (eventConnectorCreateItem == nullptr)
    {
        throw ApiException(400, U("Missing required parameter 'eventConnectorCreateItem' when calling ProcessmakerApi->addEventConnector"));
    }
    
    
    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/processes/{process_id}/events/{event_id}/connectors");
    boost::replace_all(path, U("{") U("process_id") U("}"), ApiClient::parameterToString(processId));
boost::replace_all(path, U("{") U("event_id") U("}"), ApiClient::parameterToString(eventId));
    ...
    {
        throw ApiException(400, U("ProcessmakerApi->addEventConnector does not produce any supported media type"));
    }    
    ...
    if ( consumeHttpContentTypes.size() == 0 || consumeHttpContentTypes.find(U("application/json")) != consumeHttpContentTypes.end() )
    {
        ...
        json = ModelBase::toJson(eventConnectorCreateItem);
    ...
    else if( consumeHttpContentTypes.find(U("multipart/form-data")) != consumeHttpContentTypes.end() )
    {
        ...
        if(eventConnectorCreateItem.get())
        {
            eventConnectorCreateItem->toMultipart(multipart, U("eventConnectorCreateItem"));
        }
    ...
    {
        throw ApiException(415, U("ProcessmakerApi->addEventConnector does not consume any supported media type"));
    }    
    ...
    .then([=](web::http::http_response response)
    {
		...
		{
			throw ApiException(response.status_code()
				, U("error calling addEventConnector: ") + response.reason_phrase()
				, std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
		}
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling addEventConnector: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        std::shared_ptr<EventConnector_1> result(new EventConnector_1());
...
pplx::task<std::shared_ptr<TaskConnector_1>> ProcessmakerApi::addTaskConnector(utility::string_t processId, utility::string_t taskId, std::shared_ptr<TaskConnectorCreateItem> taskConnectorCreateItem)
{
    
    // verify the required parameter 'taskConnectorCreateItem' is set
    if (taskConnectorCreateItem == nullptr)
    {
        throw ApiException(400, U("Missing required parameter 'taskConnectorCreateItem' when calling ProcessmakerApi->addTaskConnector"));
    }
    
    
    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/processes/{process_id}/tasks/{task_id}/connectors");
    boost::replace_all(path, U("{") U("process_id") U("}"), ApiClient::parameterToString(processId));
boost::replace_all(path, U("{") U("task_id") U("}"), ApiClient::parameterToString(taskId));
    ...
    {
        throw ApiException(400, U("ProcessmakerApi->addTaskConnector does not produce any supported media type"));
    }    
    ...
    if ( consumeHttpContentTypes.size() == 0 || consumeHttpContentTypes.find(U("application/json")) != consumeHttpContentTypes.end() )
    {
        ...
        json = ModelBase::toJson(taskConnectorCreateItem);
    ...
    else if( consumeHttpContentTypes.find(U("multipart/form-data")) != consumeHttpContentTypes.end() )
    {
        ...
        if(taskConnectorCreateItem.get())
        {
            taskConnectorCreateItem->toMultipart(multipart, U("taskConnectorCreateItem"));
        }
    ...
    {
        throw ApiException(415, U("ProcessmakerApi->addTaskConnector does not consume any supported media type"));
    }    
    ...
    .then([=](web::http::http_response response)
    {
		...
		{
			throw ApiException(response.status_code()
				, U("error calling addTaskConnector: ") + response.reason_phrase()
				, std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
		}
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling addTaskConnector: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        std::shared_ptr<TaskConnector_1> result(new TaskConnector_1());
...
pplx::task<std::shared_ptr<ResultSuccess>> ProcessmakerApi::deleteEventConnector(utility::string_t processId, utility::string_t eventId, utility::string_t connectorId)
{
    
    
    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/processes/{process_id}/events/{event_id}/connectors/{connector_id}");
    boost::replace_all(path, U("{") U("process_id") U("}"), ApiClient::parameterToString(processId));
boost::replace_all(path, U("{") U("event_id") U("}"), ApiClient::parameterToString(eventId));
boost::replace_all(path, U("{") U("connector_id") U("}"), ApiClient::parameterToString(connectorId));
    ...
    {
        throw ApiException(400, U("ProcessmakerApi->deleteEventConnector does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("ProcessmakerApi->deleteEventConnector does not consume any supported media type"));
    }    
    ...
    .then([=](web::http::http_response response)
    {
		...
		{
			throw ApiException(response.status_code()
				, U("error calling deleteEventConnector: ") + response.reason_phrase()
				, std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
		}
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling deleteEventConnector: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<std::shared_ptr<ResultSuccess>> ProcessmakerApi::deleteTaskConnector(utility::string_t processId, utility::string_t taskId, utility::string_t connectorId)
{
    
    
    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/processes/{process_id}/tasks/{task_id}/connectors/{connector_id}");
    boost::replace_all(path, U("{") U("process_id") U("}"), ApiClient::parameterToString(processId));
boost::replace_all(path, U("{") U("task_id") U("}"), ApiClient::parameterToString(taskId));
boost::replace_all(path, U("{") U("connector_id") U("}"), ApiClient::parameterToString(connectorId));
    ...
    {
        throw ApiException(400, U("ProcessmakerApi->deleteTaskConnector does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("ProcessmakerApi->deleteTaskConnector does not consume any supported media type"));
    }    
    ...
    .then([=](web::http::http_response response)
    {
		...
		{
			throw ApiException(response.status_code()
				, U("error calling deleteTaskConnector: ") + response.reason_phrase()
				, std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
		}
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling deleteTaskConnector: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<std::shared_ptr<ClientCollection>> ProcessmakerApi::findClients(utility::string_t userId, int32_t pagefindProcessById, int32_t perPage)
{
    ...
    {
        queryParams[U("pagefindProcessById")] = ApiClient::parameterToString(pagefindProcessById);
...
pplx::task<std::shared_ptr<EventConnector_1>> ProcessmakerApi::findEventConnectorById(utility::string_t processId, utility::string_t eventId, utility::string_t connectorId)
{
...
boost::replace_all(path, U("{") U("connector_id") U("}"), ApiClient::parameterToString(connectorId));
    ...
    {
        throw ApiException(400, U("ProcessmakerApi->findEventConnectorById does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("ProcessmakerApi->findEventConnectorById does not consume any supported media type"));
    }    
    ...
    .then([=](web::http::http_response response)
    {
		...
		{
			throw ApiException(response.status_code()
				, U("error calling findEventConnectorById: ") + response.reason_phrase()
				, std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
		}
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling findEventConnectorById: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<std::shared_ptr<EventConnectorsCollection>> ProcessmakerApi::findEventConnectors(utility::string_t processId, utility::string_t eventId, int32_t page, int32_t perPage)
{
...
boost::replace_all(path, U("{") U("event_id") U("}"), ApiClient::parameterToString(eventId));
    ...
    {
        throw ApiException(400, U("ProcessmakerApi->findEventConnectors does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("ProcessmakerApi->findEventConnectors does not consume any supported media type"));
    }    
    ...
    .then([=](web::http::http_response response)
    {
		...
		{
			throw ApiException(response.status_code()
				, U("error calling findEventConnectors: ") + response.reason_phrase()
				, std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
		}
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling findEventConnectors: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        std::shared_ptr<EventConnectorsCollection> result(new EventConnectorsCollection());
...
pplx::task<std::shared_ptr<TaskConnector_1>> ProcessmakerApi::findTaskConnectorById(utility::string_t processId, utility::string_t taskId, utility::string_t connectorId)
{
...
boost::replace_all(path, U("{") U("connector_id") U("}"), ApiClient::parameterToString(connectorId));
    ...
    {
        throw ApiException(400, U("ProcessmakerApi->findTaskConnectorById does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("ProcessmakerApi->findTaskConnectorById does not consume any supported media type"));
    }    
    ...
    .then([=](web::http::http_response response)
    {
		...
		{
			throw ApiException(response.status_code()
				, U("error calling findTaskConnectorById: ") + response.reason_phrase()
				, std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
		}
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling findTaskConnectorById: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<std::shared_ptr<TaskConnectorsCollection>> ProcessmakerApi::findTaskConnectors(utility::string_t processId, utility::string_t taskId, int32_t page, int32_t perPage)
{
...
boost::replace_all(path, U("{") U("task_id") U("}"), ApiClient::parameterToString(taskId));
    ...
    {
        throw ApiException(400, U("ProcessmakerApi->findTaskConnectors does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("ProcessmakerApi->findTaskConnectors does not consume any supported media type"));
    }    
    ...
    .then([=](web::http::http_response response)
    {
		...
		{
			throw ApiException(response.status_code()
				, U("error calling findTaskConnectors: ") + response.reason_phrase()
				, std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
		}
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling findTaskConnectors: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        std::shared_ptr<TaskConnectorsCollection> result(new TaskConnectorsCollection());
...
pplx::task<std::shared_ptr<EventConnector_1>> ProcessmakerApi::updateEventConnector(utility::string_t processId, utility::string_t eventId, utility::string_t connectorId, std::shared_ptr<EventConnectorUpdateItem> eventConnectorUpdateItem)
{
    
    // verify the required parameter 'eventConnectorUpdateItem' is set
    if (eventConnectorUpdateItem == nullptr)
    {
        throw ApiException(400, U("Missing required parameter 'eventConnectorUpdateItem' when calling ProcessmakerApi->updateEventConnector"));
    }
...
boost::replace_all(path, U("{") U("connector_id") U("}"), ApiClient::parameterToString(connectorId));
    ...
    {
        throw ApiException(400, U("ProcessmakerApi->updateEventConnector does not produce any supported media type"));
    }    
    ...
    if ( consumeHttpContentTypes.size() == 0 || consumeHttpContentTypes.find(U("application/json")) != consumeHttpContentTypes.end() )
    {
        ...
        json = ModelBase::toJson(eventConnectorUpdateItem);
    ...
    else if( consumeHttpContentTypes.find(U("multipart/form-data")) != consumeHttpContentTypes.end() )
    {
        ...
        if(eventConnectorUpdateItem.get())
        {
            eventConnectorUpdateItem->toMultipart(multipart, U("eventConnectorUpdateItem"));
        }
    ...
    {
        throw ApiException(415, U("ProcessmakerApi->updateEventConnector does not consume any supported media type"));
    }    
    ...
    .then([=](web::http::http_response response)
    {
		...
		{
			throw ApiException(response.status_code()
				, U("error calling updateEventConnector: ") + response.reason_phrase()
				, std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
		}
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling updateEventConnector: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<std::shared_ptr<TaskConnector_1>> ProcessmakerApi::updateTaskConnector(utility::string_t processId, utility::string_t taskId, utility::string_t connectorId, std::shared_ptr<TaskConnectorUpdateItem> taskConnectorUpdateItem)
{
    
    // verify the required parameter 'taskConnectorUpdateItem' is set
    if (taskConnectorUpdateItem == nullptr)
    {
        throw ApiException(400, U("Missing required parameter 'taskConnectorUpdateItem' when calling ProcessmakerApi->updateTaskConnector"));
    }
...
boost::replace_all(path, U("{") U("connector_id") U("}"), ApiClient::parameterToString(connectorId));
    ...
    {
        throw ApiException(400, U("ProcessmakerApi->updateTaskConnector does not produce any supported media type"));
    }    
    ...
    if ( consumeHttpContentTypes.size() == 0 || consumeHttpContentTypes.find(U("application/json")) != consumeHttpContentTypes.end() )
    {
        ...
        json = ModelBase::toJson(taskConnectorUpdateItem);
    ...
    else if( consumeHttpContentTypes.find(U("multipart/form-data")) != consumeHttpContentTypes.end() )
    {
        ...
        if(taskConnectorUpdateItem.get())
        {
            taskConnectorUpdateItem->toMultipart(multipart, U("taskConnectorUpdateItem"));
        }
    ...
    {
        throw ApiException(415, U("ProcessmakerApi->updateTaskConnector does not consume any supported media type"));
    }    
    ...
    .then([=](web::http::http_response response)
    {
		...
		{
			throw ApiException(response.status_code()
				, U("error calling updateTaskConnector: ") + response.reason_phrase()
				, std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
		}
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling updateTaskConnector: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
